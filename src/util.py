...
def plot_score():
    ...
    ax1.plot(clactual_bin, clpredicted_bin, marker=".", color="green", linestyle="None")
    ...
    ax2.plot(cdactual_bin, cdpredicted_bin, marker=".", color="green", linestyle="None")
    ...
    ax3.plot(cmactual_bin, cmpredicted_bin, marker=".", color="green", linestyle="None")
    ...
    ax4.plot(clactual_um, clpredicted_um, marker=".", color="green", linestyle="None")
    ...
    ax5.plot(cdactual_um, cdpredicted_um, marker=".", color="green", linestyle="None")
    ...
    ax6.plot(cmactual_um, cmpredicted_um, marker=".", color="green", linestyle="None")
    ...
    ax7.plot(clactual_sdf, clpredicted_sdf, marker=".", color="green", linestyle="None")
    ...
    ax8.plot(cdactual_sdf, cdpredicted_sdf, marker=".", color="green", linestyle="None")
    ...
    ax9.plot(cmactual_sdf, cmpredicted_sdf, marker=".", color="green", linestyle="None")
